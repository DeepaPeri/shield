...
import com.tv.shield.acl.Roles;
...
import com.tv.shield.notification.Email;
import com.tv.shield.notification.NotificationMedium;
import com.tv.shield.notification.NotificationTypes;
import com.tv.shield.notification.Pager;
import com.tv.shield.notification.Sms;
import java.util.HashSet;
import java.util.Objects;
import java.util.Set;

public class InMemoryDataSourceImpl implements InMemoryDataSource{
    ...
    public Captain getCaptain(String captainName) {
        for (Captain captain : captains) {
            if (captain.getCaptainName().equals(captainName)) {
                return captain;
            }
        }
        return null;
    ...
    public boolean equals(Object o) {
        ...
        InMemoryDataSourceImpl that = (InMemoryDataSourceImpl) o;
        return getAvengers().equals(that.getAvengers()) &&
                getCaptains().equals(that.getCaptains()) &&
                getMissions().equals(that.getMissions());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getAvengers(), getCaptains(), getMissions());
    }
}
